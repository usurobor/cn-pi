...
**user**: So do we keep reflections in daily? Don you have them? Do we have a clear coherent reflect skill defined?
...
**user**: 1. Yes, so that future you remembers these insights. Are we clear you need to be recording mci-s?
2. Give new the issue text to create. Does it out based on issue capturing skill outlining what’s expected, etc

**assistant**: Updated today's reflection. Now for the issue:
