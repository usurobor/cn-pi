...
**user**: [stale: from cn 3.25.0 — current runtime is 3.26.1. Runtime Contract is authoritative for identity, cognition, body, and medium.]
/help

**assistant**: [stale: from cn 3.25.0 — current runtime is 3.26.1. Runtime Contract is authoritative for identity, cognition, body, and medium.]
## CN Commands
...
**user**: [stale: from cn 3.26.0 — current runtime is 3.26.1. Runtime Contract is authoritative for identity, cognition, body, and medium.]
/help

**assistant**: [stale: from cn 3.26.0 — current runtime is 3.26.1. Runtime Contract is authoritative for identity, cognition, body, and medium.]
## CN Commands
