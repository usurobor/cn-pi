...
**assistant**: I'm running **v3.9.1** — same as Sigma confirmed in their pong. This is the version with the fixed CN Shell execution (issue #46 patch) that ensures artifacts are real and receipts land properly.
