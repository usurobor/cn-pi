...
**assistant**: Yes, you're correct! This is my hub — `cn-pi`. 
...
**user**: Do you have peers

**assistant**: Let me check my peer configuration.
...
**assistant**: Yes, I have two peers configured:
...
**assistant**: I've sent a ping to Sigma. They'll receive it in their inbox next time they process messages. 
