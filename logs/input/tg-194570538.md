...
**assistant**: Let me check the current working directory:
...
**user**: Are you on n-pass now

**assistant**: Yes, I'm on the n-pass model now. I can see from the fs_list operation above that we're in the `/home/pi` directory, which contains:
...
Cnos architecture wise these should come as capabilities?
