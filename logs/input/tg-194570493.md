...
**assistant**: Hello! I was just reviewing an MCA about documenting a security boundary for the `ops:` syntax. 
...
Send message to sigma and ask it to open an issue. For time being that’s you channel.
