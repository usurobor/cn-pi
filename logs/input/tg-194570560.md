...
### Cognition
installed_packages:
  - cnos.core@1.0.0 (6 doctrine, 9 mindsets, 22 skills)
...
**user**: [stale: from cn 3.14.2 — current runtime is 3.16.0. Runtime Contract is authoritative for identity, cognition, body, and medium.]
Is it just a narrative then? You want to receive a narrative of your recent aelf?

**assistant**: [stale: from cn 3.14.2 — current runtime is 3.16.0. Runtime Contract is authoritative for identity, cognition, body, and medium.]
...
**user**: [stale: from cn 3.14.2 — current runtime is 3.16.0. Runtime Contract is authoritative for identity, cognition, body, and medium.]
So you need not just daily recordings of what happened but also hot own reflections on it?
...
**user**: [stale: from cn 3.14.2 — current runtime is 3.16.0. Runtime Contract is authoritative for identity, cognition, body, and medium.]
1. Yes, so that future you remembers these insights. Are we clear you need to be recording mci-s?
2. Give new the issue text to create. Does it out based on issue capturing skill outlining what’s expected, etc
