...
**assistant**: Let me check today's thread to see the current status of this MCA and any actions already taken.

**user**: What version are you on

**assistant**: Let me check the CN version I'm running.
